// Generated from C:/Users/mynam/Documents/Compiladores-GCC130--ProjetoFinal/src/giriaScript.g4 by ANTLR 4.13.1
...
public class giriaScriptLexer extends Lexer {
	...
	public static final int
		...
		FB=11, AP=12, FP=13, FL=14, LOGIC=15, RELAC=16, ID=17, NUM=18, WS=19, 
		ERROR=20;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"FB", "AP", "FP", "FL", "LOGIC", "RELAC", "ID", "NUM", "WS", "ERROR", 
			"LETRA", "DIGITO"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"AB", "FB", "AP", "FP", "FL", "LOGIC", "RELAC", "ID", "NUM", "WS", "ERROR"
		};
	}
